...
# ========== Registration Step 5 ========== #
if pgrep -f "regStep5.php" > /dev/null;
then
	echo "File [regStep5] is running"
else
	echo "File [regStep5] is not running, starting it now"
	gnome-terminal -- php IT490ApacheSite/regStep5.php
fi

# ========== Login Step 5 ========== #
if pgrep -f "logStep5.php" > /dev/null;
then    
        echo "File [logStep5] is running"
else    
        echo "File [logStep5] is not running, starting it now"
        gnome-terminal -- php IT490ApacheSite/logStep5.php
fi
