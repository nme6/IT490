...
//$callback = function ($message, $channel, $actual_ip) {
...
//#################################[Registration Validation]##########################################	    
	...
	//$errorConnection = new AMQPStreamConnection('192.168.191.67', 5672, 'admin', 'admin');
	...
	if (!$errorConnection) {
        ...
        $errorChannel->queue_declare('regBE2FE', false, false, false, false, ['x-ha-policy'=>'all']);
	...
	//$successConnection = new AMQPStreamConnection('192.168.191.67', 5672, 'admin', 'admin');
...
//$actual_ip = null;
	...
	if (!$successConnection) {
    	...
    	$successChannel->queue_declare('regBE2DB', false, false, false, false, ['x-ha-policy'=>'all']);
